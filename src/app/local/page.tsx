          ...
          <div className="max-w-xl mx-auto text-center w-full">
            ...
            >
              <div className="border border-gray-200 rounded-2xl p-10 md:p-12 shadow-lg bg-white/95 relative">
                ...
                {/* 제목 */}
                <h1 className="text-2xl md:text-3xl font-semibold mb-12 md:mb-16 tracking-wider text-black">
                  신랑측 피로연 안내
                </h1>
                ...
                >
                  <p className="text-lg md:text-xl font-extralight tracking-wide text-gray-600 leading-relaxed">
                    거리가 멀어 예식에 참석하시기<br />
                    어려운 분들을 위해 혼례에 앞서<br />
                    피로연 자리를 마련하였습니다.
                  </p>
                  <p className="text-lg md:text-xl font-extralight tracking-wide text-gray-600 leading-relaxed mt-4">
                    귀한 발걸음으로<br />
                ...
                >
                  <div className="flex items-center justify-center gap-2 mb-4">
                    <span className="text-gray-700 text-lg font-extralight tracking-wide">신랑</span>
                    <svg 
                    ...
                    <span className="text-gray-700 text-lg font-extralight tracking-wide">신부</span>
                  </div>
            ...
            <div className="mt-8 text-center">
              <div className="flex flex-col items-center space-y-2">
                ...
                <p className="text-xs text-gray-500 font-extralight tracking-wide">
                  아래로 스크롤
                </p>
              </div>
            </div>
                  ...
                  <div className="flex items-center justify-between py-4 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-base font-medium text-gray-800">2026년 4월 1일 (토) 오후 6시</div>
                      </div>
                    </div>
                  </div>
